...
<head>
	...
	<LINK HREF="screen1024px-fixed%20sidebars.css" REL="stylesheet" TYPE="text/css" media="screen, tv, projection">
	<style type="text/css">
...
<body>
	<!--all container contains all but sidebars-->
	<div id="all_container">
		<!--Bar at top containing menu and logo -->
		<div id="top">
	...
	<div id="sidebar_right">
		...
		<div id="active_playlists_container">
			<ul id="active_playlists" class="">
				...
				<li>
variant_abs					Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!!Text Right!!!!<br />
